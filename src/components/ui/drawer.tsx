  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-background dark:border-gray-600 fixed z-50 flex h-[90vh] flex-col",
      ...
      >
        ...
        <VisuallyHidden asChild>
          <DrawerPrimitive.Description>
            A drawer that appears on top of the main content.
          </DrawerPrimitive.Description>
        </VisuallyHidden>
...
function DrawerTitle({
  ...
  return (
    <DrawerPrimitive.Title
      ...
      className={cn(
        "text-foreground font-semibold text-gray-800 dark:text-gray-100",
        className
      )}
      {...props}
    />
