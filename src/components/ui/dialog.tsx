    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // Proper positioning - centered on all devices
          "fixed z-50 grid w-full gap-4 rounded-lg border p-6 shadow-lg duration-200",
          "min-w-[320px] transition-all ease-in-out",
          // Centered positioning with proper margins
          "top-[50%] left-[50%] max-w-[calc(100vw-2rem)] translate-x-[-50%] translate-y-[-50%] sm:max-w-md",
